...
# left ear
draw(y = ((0.1 * ((x - 160) ^ 2)) + 250), [x < 157, y < 290], (0, 0, 0), "funky")
draw(y = ((3 * sqrt((-1 * (x - 180)))) + 270), [x < 200, y < 289], (0, 0, 0), "funky")

# right ear
draw(y = ((0.1 * ((x - 240) ^ 2)) + 250), [x > 240, y < 290], (0, 0, 0), "funky")
draw(y = ((3 * sqrt((x - 220))) + 270), [x > 200, y < 289], (0, 0, 0), "funky")
